...
MIMETYPES = set.union(*EXTENSION_TO_MIMETYPE.values())
MIMETYPE_DOMAINS = set.union(*[set([MIMETYPE_REGEX.match(mimetype).groups()[0] for mimetype in mimetypes]) for mimetypes in EXTENSION_TO_MIMETYPE.values()])
