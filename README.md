...
This library is still in alpha and should not be used in a production setting! Issues and Pull Requests welcome!
...
### Benchmarks
Benchmarks both use `wrk -t250 -c500 -d30 http://127.0.0.1:8080` to create connections.
